...
public final class ChatFragmentBinding implements ViewBinding {
  ...
  private ChatFragmentBinding(@NonNull RelativeLayout rootView, @NonNull CardView cardViewImage,
      @NonNull CardView cardviews, @NonNull ImageView imageView,
      @NonNull ImageView ivTopProfilePictureChat, @NonNull EditText messageEditText,
      @NonNull LinearLayout messageInputLayout, @NonNull TextView nameOfChat,
  ...
  public static ChatFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ChatFragmentBinding((RelativeLayout) rootView, cardViewImage, cardviews, imageView,
          ivTopProfilePictureChat, messageEditText, messageInputLayout, nameOfChat, recyclerView,
          sendButton);
    }
